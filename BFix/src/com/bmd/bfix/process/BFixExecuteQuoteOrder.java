...
public class BFixExecuteQuoteOrder implements Runnable {
	private BFixApplication bFixAplication;
	private BFixExecutionTableModel bFixExecutionTableModel;
	private BFixOrder order;
	
	public BFixExecuteQuoteOrder(BFixOrder order, BFixApplication bFixAplication, BFixExecutionTableModel bFixExecutionTableModel) {
