...
public class BFixExecutionTableModel extends AbstractTableModel {
	...
	private final static int LASTQTY = 7;
	private final static int LASTPX = 8;
	private final static int LEAVESQTY = 9;
	private final static int TIMEINFORCE = 10;
	private final static int TRANSACTTIME = 11;
	private final static int EXECTYPE = 12;
	
	
	private List<BFixOrder> orders;
	...
	public BFixExecutionTableModel() {
		orders = new ArrayList<BFixOrder>();
		...
		headers = new String[] { "Kurum No", "Emir No", "Sembol", "İşlem", "Fiyat",
				"Miktar", "Tutar", "G. Miktar", "G. Fiyat", "Kalan", "Süre", "Saat", "Durum" };
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case LASTPX:
			return order.getLastPx();
		case LASTQTY:
			return order.getLastQty();
		case LEAVESQTY:
